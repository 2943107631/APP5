...
import com.example.databinding.FragmentCLiaoTianBinding;
...
public class CLiaoTianFragment extends Base2<FragmentCLiaoTianBinding> {

    private String id;
    private List<LiaoTianBean> list = new ArrayList<>();

    @Override
    protected FragmentCLiaoTianBinding getViewBinding() {
        return FragmentCLiaoTianBinding.inflate(getLayoutInflater());
    }
